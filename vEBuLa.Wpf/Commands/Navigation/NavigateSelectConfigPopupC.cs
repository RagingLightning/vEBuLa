...
namespace vEBuLa;
internal class NavigateSelectConfigPopupC : NavigateScreenC {
  private SelectConfigPopupVM Popup;

  public NavigateSelectConfigPopupC(EbulaScreenVM screen, SelectConfigPopupVM popup) {
    Popup = popup;
